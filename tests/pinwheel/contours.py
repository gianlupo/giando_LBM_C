...
def save_plot(
  ...
  rect = plt.Rectangle((190, 156), 20., 100., angle=angle, rotation_point='center', color='k', alpha=0.6)
  circ = plt.Circle((200, 206), 2., color='k')
  ax.add_patch(rect)
  ax.add_patch(circ)
...
def main():
  ...
  thetafile = np.loadtxt(DATA_DIR / f"theta.time")
  theta = thetafile[:,2]
